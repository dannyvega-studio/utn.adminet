<?php
	...
	$sentencia_select=$con->prepare('SELECT * FROM empresa_solicitante ORDER BY ID_Empresa ASC');
	...
	if(isset($_POST['btn_buscar'])){
		...
		$select_buscar=$con->prepare('
			SELECT * FROM empresa_solicitante WHERE Nombre_Empresa LIKE :campo OR RFC_Empresa LIKE :campo;'
		);
		...
		<table id="tablaempsoliciante" class="table table-striped table-bordered table-condensed"  style="width: 100%">
			...
			<?php foreach($resultado as $fila):?>
				<tr >
					...
					<td><?php echo $fila['RFC_Empresa']; ?></td>
					<td><?php echo $fila['Ubicacion_Empresa']; ?></td>
					<td><?php echo $fila['Telefono_Empresa']; ?></td>
					<td><?php echo $fila['Correo_Empresa']; ?></td>
					<td><a href="vistas/actualizar_empresas.php?ID_Empresa=<?php echo $fila['ID_Empresa']; ?>"  class="btn__update" >Editar</a></td>
					<td><a href="crud/delete.php?ID_Empresa=<?php echo $fila['ID_Empresa']; ?>" class="btn__delete">Eliminar</a></td>
				</tr>
			<?php endforeach ?>
