...
function Header()
{
    ...
    $this->Cell(45);
    // Título
    $this->Cell(100,10,'Reporte | Informacion de servicios | 2010 - 2019',0,0,'C');
    $this->Ln(20);
    ...
    $this->Ln(10);
    $this->Cell(50,5, utf8_decode('Periodo 2010 - 2019.'));
...
$this->cell(70,10, 'Servicio', 1, 0, 'C',0);
...
function Footer()
{
   ...
   $sentencia_select=$con->prepare('SELECT * FROM servicios_2010_2019');
