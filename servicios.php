<?php
	...
	$sentencia_select=$con->prepare('SELECT * FROM servicios ORDER BY ID_Servicio ASC');
	...
	if(isset($_POST['btn_buscar'])){
		...
		$select_buscar=$con->prepare('
			SELECT * FROM servicios WHERE ID_Servicio LIKE :campo OR ID_Departamento LIKE :campo;'
		);
...
<body>
  ...
  <!-- Fin Navbar -->
	...
	<div class="contenedor">
		<h2>Registro de nuevos servicios</h2>
		<div class="barra__buscador">
			<form action="" class="formulario" method="post">
				<input type="text" name="buscar" placeholder="Buscar Empresa" 
				value="<?php if(isset($buscar_text)) echo $buscar_text; ?>" class="input__text">
				<input type="submit" class="btn" name="btn_buscar" value="Buscar">
				<a href="vistas/registro_servicios.php" class="btn btn__nuevo">Nuevo</a>
			</form>
		</div>
		<table id="tablaempsoliciante" class="table table-striped table-bordered table-condensed"  style="width: 100%">
			<tr class="head">
                ...
                <th>Identificador de departamento</th>
			...
			<?php foreach($resultado as $fila):?>
				<tr >
					...
					<td><a href="vistas/actualizar_servicios.php?ID_Servicio=<?php echo $fila['ID_Servicio']; ?>"  class="btn__update" >Editar</a></td>
					<td><a href="crud/serviciodelete.php?ID_Servicio=<?php echo $fila['ID_Servicio']; ?>" class="btn__delete">Eliminar</a></td>
				</tr>
			<?php endforeach ?>
