<?php 
	include_once '../crud/servicioupdate.php';
?>
...
<!-- Fin Menu -->
	...
	<div class="contenedor">
		<h2>Modificar informacion de los servicios</h2>
		<form action="" method="post">
			<div class="form-group">
				<input type="text" id="Nombre_Servicio" name="Nombre_Servicio" value="<?php if($resultado) echo $resultado['Nombre_Servicio']; ?>" class="input__text">
			...
			<div class="btn__group">
				...
				<input type="submit" id="actualizarServicio" name="actualizar_servicio" value="Guardar" class="btn btn__primary">
			</div>
		</form>
	</div>
