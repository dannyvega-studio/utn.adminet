	<?php
		...
		$sentencia_select=$con->prepare('SELECT * FROM contrato ORDER BY ID_Puesto ASC');
		...
		if(isset($_POST['btn_buscar'])){
			...
			$select_buscar=$con->prepare('
				SELECT * FROM contrato WHERE ID_Empleado LIKE :campo OR ID_Puesto LIKE :campo;'
			);
		...
		<div class="contenedor">
			...
			<div class="barra__buscador">
				<form action="" class="formulario" method="post">
					...
					<a href="vistas/registro_contratos.php" class="btn btn__nuevo">Nuevo</a>
				</form>
			</div>
			<table id="tablacontratos" class="table table-striped table-bordered table-condensed"  style="width: 100%">
				...
				<?php foreach($resultado as $fila):?>
					<tr >
						...
						<td><?php echo $fila['Fecha_Renovacion_Contrato']; ?></td>
						<td><?php echo $fila['Sueldo']; ?></td>
						<td><a href="vistas/actualizar_contrato.php?ID_Empleado=<?php echo $fila['ID_Empleado']; ?>"  class="btn__update" >Editar</a></td>
						<td><a href="crud/contratodelete.php?ID_Empleado=<?php echo $fila['ID_Empleado']; ?>" class="btn__delete">Eliminar</a></td>
					</tr>
				<?php endforeach ?>
